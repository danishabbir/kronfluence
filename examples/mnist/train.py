...
from experiments.mnist.pipeline import construct_model, get_hyperparameters, get_loaders
from experiments.utils import clear_gpu_cache, save_tensor, set_seed
...
if __name__ == "__main__":
    ...
    for dn in data_names:
        main(data_name=dn, do_corrupt=False, num_train=5)
        main(data_name=dn, do_corrupt=True, num_train=5)
